...
pactl load-module module-null-sink sink_name=voicechat sink_properties="device.description='VoiceChat'"
pactl load-module module-null-sink sink_name=system sink_properties="device.description='System'"
pactl load-module module-null-sink sink_name=aux1 sink_properties="device.description='Aux1'"
pactl load-module module-null-sink sink_name=aux2 sink_properties="device.description='Aux2'"
pactl load-module module-null-sink sink_name=aux3 sink_properties="device.description='Aux3'"